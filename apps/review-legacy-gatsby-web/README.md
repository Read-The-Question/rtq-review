...
Generated Markdown belongs under `src/pages/md`. Mirrored paper assets belong
under `static/assets/papers`. Both are populated by canonical tooling in
`rtq-content/packages/papers`; do not introduce a second exporter or asset-copy
implementation here.
