...
![warwick-school--11-plus--maths--9999--sample-paper-1/section-1-question-27-00.png](/assets/warwick-school--11-plus--maths--9999--sample-paper-1/section-1-question-27-00.png "warwick-school--11-plus--maths--9999--sample-paper-1/section-1-question-27-00.png")

</div>
<div class='questioncodeblock'>
<pre class='language-latex'><code class='language-latex'>The diagram represents a carton of orange juice in the shape of a cuboid. The carton is full. 
%image%
</code></pre>
</div>
...
<div class='questioncodeblock'>
<pre class='language-latex'><code class='language-latex'>Using the formula $Volume = length \times width \times height$, calculate the volume of orange juice in the carton. 
</code></pre>
</div>
...
A cup holds $120\, cm^3$ of liquid. 

How many cups can be filled from the full carton of orange juice?

</div>
<div class='questioncodeblock'>
<pre class='language-latex'><code class='language-latex'>A cup holds $120\, cm^3$ of liquid. 
<emptyline>
How many cups can be filled from the full carton of orange juice?
</code></pre>
</div>
...
<div class='questioncodeblock'>
<pre class='language-latex'><code class='language-latex'>Jane drinks $216 \ \text{cm}^3$ of orange juice from the carton. 
<emptyline>
What is the new height of orange juice in the carton? 
</code></pre>
</div>
...
<li class='review'>
<button class='review rag_prg2' data-rag='PRG2' data-review-type='REVIEW_QUESTION' data-reviewer='up' data-sheet='PR' data-uuid='18581DC5-877B-43DE-8089-69B5096D5DC7' onclick='submitReview(event)'>PRG2</button>
</li>
<li class='review'>
<button class='review rag_prcr' data-rag='PRCR' data-review-type='REVIEW_QUESTION' data-reviewer='up' data-sheet='PR' data-uuid='18581DC5-877B-43DE-8089-69B5096D5DC7' onclick='submitReview(event)'>PRCR</button>
</li>
<li class='review'>
...
<li class='review'>
<button class='review rag_prbd' data-rag='PRBD' data-review-type='REVIEW_QUESTION' data-reviewer='up' data-sheet='PR' data-uuid='18581DC5-877B-43DE-8089-69B5096D5DC7' onclick='submitReview(event)'>PRBD</button>
</li>
<li class='review'>
...
<li class='review'>
<button class='review rag_prct' data-review-type='REVIEW_QUESTION' data-sheet='PR' data-uuid='18581DC5-877B-43DE-8089-69B5096D5DC7' onclick='resetComment(event)'>Reset Comments</button>
</li>
</ul>
...
<p class='review_status initial' id='REVIEW-STATUS-18581DC5-877B-43DE-8089-69B5096D5DC7'>Initial</p>
</div>
</div>
</li>
</ul>
