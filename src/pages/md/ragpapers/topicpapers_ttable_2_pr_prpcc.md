---
slug: "ragpapers/topicpapers-ttable-2-pr-prpcc"
title: "TopicPaper - Table - 2 - PR - PRPCC"
...
Using your values in ($\text{a}$) and choosing a sensible scale, plot a graph of $y$ against $x$.
...
Study the pattern of numbers in the table below carefully. Column $\text{B}$ gives the mean (average) of the numbers listed in Column $\text{A}$.
