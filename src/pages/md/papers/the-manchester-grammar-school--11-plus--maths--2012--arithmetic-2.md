...
<li class='review'>
<button class='review rag_prg' data-rag='PRG2' data-sheet='G1' data-uuid='AAF65CC9-5279-4F5B-B1ED-55EDBBE85A8B' onclick='submitReview(event)'>PRG2</button>
</li>
</ul>
...
<ul class='review'>
<li class='review'>
<button class='review rag_prg' data-rag='PRG' data-sheet='G1' data-uuid='589E5E44-10C8-4537-8ED7-9C02B0A0532C' onclick='submitReview(event)'>PRG</button>
</li>
<li class='review'>
<button class='review rag_prcr' data-rag='PRCR' data-sheet='G1' data-uuid='589E5E44-10C8-4537-8ED7-9C02B0A0532C' onclick='submitReview(event)'>PRCR</button>
</li>
<li class='review'>
<button class='review rag_prcc' data-rag='PRCC' data-sheet='G1' data-uuid='589E5E44-10C8-4537-8ED7-9C02B0A0532C' onclick='submitReview(event)'>PRCC</button>
</li>
<li class='review'>
<button class='review rag_prr' data-rag='PRR' data-sheet='G1' data-uuid='589E5E44-10C8-4537-8ED7-9C02B0A0532C' onclick='submitReview(event)'>PRR</button>
</li>
<li class='review'>
<button class='review rag_prbd' data-rag='PRBD' data-sheet='G1' data-uuid='589E5E44-10C8-4537-8ED7-9C02B0A0532C' onclick='submitReview(event)'>PRBD</button>
</li>
<li class='review'>
<button class='review rag_prct' data-rag='PRCT' data-sheet='G1' data-uuid='589E5E44-10C8-4537-8ED7-9C02B0A0532C' onclick='submitReview(event)'>PRCT</button>
</li>
<li class='review'>
<button class='review rag_prg' data-rag='PRG2' data-sheet='G1' data-uuid='589E5E44-10C8-4537-8ED7-9C02B0A0532C' onclick='submitReview(event)'>PRG2</button>
</li>
</ul>

<form class='review' data-sheet='G1' data-uuid='589E5E44-10C8-4537-8ED7-9C02B0A0532C' id='FORM-589E5E44-10C8-4537-8ED7-9C02B0A0532C' onsubmit='submitComment(event)'>
<textarea cols='30' name='comment' placeholder='Enter review comments ...' required rows='10'></textarea>
<br>
<input type='submit' value='Submit'>
<input type='reset' value='Reset'>
